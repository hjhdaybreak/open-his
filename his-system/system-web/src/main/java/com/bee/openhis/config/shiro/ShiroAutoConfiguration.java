...
public class ShiroAutoConfiguration {
    ...
    @Bean
    @ConditionalOnClass(value = DefaultWebSecurityManager.class) //这个注解通俗的说就是Spring工程中引用了xxx的包 才会构建这个bean
    ...
    /**
     * -声明过滤器
     * Shiro 的Web过滤器 id 必须和web.xml里面的shiroFilter的 targetBeanName的值一样
     */
    ...
    public ShiroFilterFactoryBean getShiroFilterFactoryBean(DefaultWebSecurityManager securityManager) {
        ...
        //配置拦截的路径
        String[] authcUrls = this.shiroProperties.getAuthUrls();
     ...
     *
     * @param redisSessionDao defaultWebSessionManager来源com.bee.system.config.TokenWebSessionManager
     * @return
     */
    @Bean
